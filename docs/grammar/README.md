...
| **Widget-UI also tested on** | n8n (Node/TypeORM, 2/6 gram, 6/6 UI), **Listmonk** (Go mailing, **6/6 = 100%**), **Keycloak** (Java IAM, 92 tables, 5/8 gram + 7/8 UI = complex enterprise schema works) |
