...
| **Tests** | **359 npm + 400 Rails = 759 passing.** V1.2 #1-#6 + #8 landed: identifier quoting, entity disambiguation, COUNT sanity check, naming-convention aliases (Django/TypeORM/Keycloak), graceful LLM-fallback. Live-verified end-to-end. |
