...
describe('modifiers', () => {
  it('applies WHERE with enum value resolution (quoted)', () => {
  ...
  it('applies TIME last_30_days (quoted)', () => {
  ...
  it('applies JOIN using association joinClause (quoted)', () => {
